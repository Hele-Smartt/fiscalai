        ...
        <nav className={`sidebar ${collapsed ? "collapsed" : ""}`}>
          ...
          <div className="sidebar-bottom">
            <div className="user-card">
              ...
              {!collapsed && <div className="user-info"><div className="user-name">Regis Carvalho</div><div className="user-role">Admin · Acme Ltda.</div></div>}
            </div>
          </div>
        </nav>
        ...
        <div className="main">
          <header className="topbar">
            ...
            <div className="topbar-actions">
              ...
              <div className="user-avatar" style={{ width: 30, height: 30, borderRadius: 8, background: "linear-gradient(135deg,var(--accent2),var(--accent4))", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 12, fontWeight: 700, color: "#fff", cursor: "pointer" }}>RC</div>
            </div>
          </header>
