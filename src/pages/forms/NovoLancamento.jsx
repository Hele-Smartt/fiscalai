...
export default function NovoLancamento({ onBack, onSaved }) {
  ...
  useEffect(() => {
    ...
    Categorias.listar(empresa.id).then(({ data }) => setCategorias(data || []))
  ...
  async function handleSubmit(e) {
    e.preventDefault()
    if (!form.descricao || !form.valor || !form.data_lancamento) {
  ...
  return (
    <>
      ...
      <div className="form-page fade-up">
        ...
        {sucesso && <div className="success-banner">✅ Lançamento registrado com sucesso!</div>}
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-card">
            ...
            <div className="tipo-toggle">
              {['entrada', 'saida'].map(t => (
                <div key={t}
                  className={`tipo-btn ${t} ${form.tipo === t ? 'active' : ''}`}
                  onClick={() => set('tipo', t)}
                >
          ...
          <div className="form-card">
            ...
            <div className="form-grid form-grid-1" style={{ gap: 16 }}>
              <Field label="Descrição" required>
                <Input
                  placeholder="Ex: Pagamento de serviços, Receita de vendas..."
              ...
              <div className="form-grid form-grid-2">
                ...
                <Field label="Data de Competência" hint="Opcional — mês de referência">
